    ...
    <div class="h-full py-4 overflow-y-auto bg-gray-900 dark:bg-gray-800 flex flex-col justify-between">
        ...
        <div class="font-medium">
            <form action="{{ route('auth.logout') }}" method="POST">
                ...
                <button type="submit"
                        class="flex text-left items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-700 group w-full">
...
<header class="flex items-center justify-end bg-white py-5 px-20 w-full">
    <div class="flex items-center justify-center space-x-5 relative">
        ...
        {{--TODO: need to change this dropdown to tailwind dropdown --}}
        <div id="dropdown-menu"
            ...
            <form action="{{ route('auth.logout') }}" method="POST" class="w-full">
                ...
                <button type="submit" class="self-start py-3 px-5 w-full hover:bg-gray-300 w-full text-left">
                    Logout
                </button>
            </form>
        </div>
